 ...
 <form onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="card flex-shrink-0 w-[1024 px] max-w-3xl shadow-2xl bg-base-100">
					<div className="card-body">
						...
						<select name="pan" className="select select-bordered w-full max-w-xs"  {...register("pan")}>
							<option value="210*297">210*297</option>
						</select>
						<label className="label">
							<span className="label-text">용지</span>
						</label>
						<select napme="paper" className="select select-bordered w-full max-w-xs"  {...register("paper")}>
